...
class UIController {
    constructor() {
        ...
        this.currentBackgroundIndex = localStorage.getItem('backgroundIndex') ? parseInt(localStorage.getItem('backgroundIndex')) : 3;
        this.backgroundImages = ['1.png', '2.png', '3.png', '4.png'];
